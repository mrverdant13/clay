  ...
  group('scanImportViolations', () {
    ...
    test('flags disallowed packages in conditional imports', () {
      expect(
        scanImportViolations(
          lines: [
            "import 'package:clay_core/foo.dart'",
    ...
    test('flags internal package paths', () {
      expect(
        scanImportViolations(
          lines: ["import 'package:clay_core/src/_internal/hidden.dart';"],
          relativePath: relativePath,
          allowedPackages: allowedPackages,
        ),
        [
          'example.dart:1: internal path package:clay_core/src/_internal/hidden.dart',
        ],
      );
    });
